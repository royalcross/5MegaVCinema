...
public class MovieController {
	...
	public String sindorim(@RequestParam(defaultValue = "") String searchKeyword,
		...
		List<Map<String, String>> playList = service.getPlayList(searchKeyword, startRow, listLimit);
//		System.out.println(movieList);
	...
	@GetMapping("datelist20")
	public String sindorim2(@RequestParam(defaultValue = "") String searchKeyword,
			@RequestParam(defaultValue = "1") int pageNum, Model model) {
...
//		System.out.println(movieList);
		...
		return"theater/theater_sindorim2";
	}
	@GetMapping("datelist21")
	public String sindorim3(@RequestParam(defaultValue = "") String searchKeyword,
			@RequestParam(defaultValue = "1") int pageNum, Model model) {
...
//		System.out.println(movieList);
		...
		return"theater/theater_sindorim3";
	}
...
//		
	...
	@GetMapping("chungra")
	public String chungra(@RequestParam(defaultValue = "") String searchKeyword,
			@RequestParam(defaultValue = "1") int pageNum, Model model) {
		int listLimit = 10; //페이지 당 게시물 수
		int startRow = (pageNum - 1) * listLimit; //조회할 게시물의 행 번호
...
//		System.out.println(movieList);
	...
	@GetMapping("cdatelist20")
	public String chungra2(@RequestParam(defaultValue = "") String searchKeyword,
			@RequestParam(defaultValue = "1") int pageNum, Model model) {
		int listLimit = 10; //페이지 당 게시물 수
		int startRow = (pageNum - 1) * listLimit; //조회할 게시물의 행 번호
...
//		System.out.println(movieList);
		...
		return"theater/theater_chungra";
	}@GetMapping("cdatelist21")
	public String chungra3(@RequestParam(defaultValue = "") String searchKeyword,
			@RequestParam(defaultValue = "1") int pageNum, Model model) {
		int listLimit = 10; //페이지 당 게시물 수
		int startRow = (pageNum - 1) * listLimit; //조회할 게시물의 행 번호
