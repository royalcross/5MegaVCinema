...
import com.itwillbs.vCinema.service.AdminCsService;
...
//		System.out.println(notice);
	...
	public String adminNoticeModify(@RequestParam(defaultValue = "0") int notice_num, Model model) {
...
//		System.out.println("가져온 notice : " + selectedNotice);
	...
	public String AdminNoticeModifyPro (Model model, @RequestParam(defaultValue = "0") int notice_num, 
										@RequestParam(defaultValue = "") String notice_theater_name, 
										@RequestParam(defaultValue = "") String notice_subject, 
										@RequestParam(defaultValue = "") String notice_content) {
		// 공지사항 수정 (update)
		int updateCount = service.adminNoticeModify(notice_num,notice_theater_name,notice_subject,notice_content);
...
//				System.out.println(listCount);
	...
	public String adminFaqDelete(@RequestParam(defaultValue = "0") int FAQ_num, Model model) {
		
		int deleteCount = service.removeFaq(FAQ_num);
	...
	public String adminFaqModify(@RequestParam(defaultValue = "0") int FAQ_num, Model model) {
	...
	public String adminFaqModifyPro (Model model, @RequestParam(defaultValue = "0") int FAQ_num, 
		...
		// 수정 (update)
		int updateCount = service.adminFaqModify(FAQ_num,FAQ_category,FAQ_subject,FAQ_content);
...
//				System.out.println(listCount);
	...
	public String adminCsRegist(@RequestParam(defaultValue = "0") int cs_num, Model model) {
	...
	public String adminCsView(@RequestParam(defaultValue = "0") int cs_num, Model model) {
