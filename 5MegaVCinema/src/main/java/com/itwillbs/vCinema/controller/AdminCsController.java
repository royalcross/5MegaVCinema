...
//		System.out.println(noticeList);
	...
	public String adminNoticeDelete(@RequestParam(defaultValue = "1") int notice_num, Model model) {
...
//		
//		// 관리자 - 공지사항 리스트
//		List<NoticeVO> noticeList = service.getFaqList(startRow, listLimit, searchKeyword);
//
////		System.out.println(noticeList);
//		model.addAttribute("noticeList", noticeList);
//		model.addAttribute("pageInfo", pageInfo);
